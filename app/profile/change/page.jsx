...
const ProfilePhotoChanger = dynamic(() => import("../../../components/changes/PhotoChange"), {
  loading: () => <p>Завантаження...</p>,
});

const MailPassChange = dynamic(() => import("../../../components/changes/MailPassChange"), {
  loading: () => <p>Завантаження...</p>,
});
          ...
          {tabs.map(({ id, label }) => (
            <Button
              ...
              className={cn(
                ...
                tab === id ? "bg-white shadow-sm font-medium" : "hover:bg-muted-foreground/10"
              )}
