...
const RightSideInfo = () => {
  return (
    <div className="flex flex-col">
      <h1 className="text-[55px] font-normal">Dodge Challenger</h1>
      <p className="text-[40px] font-normal">47 924 $</p>
      <Button className="bg-blue-500 hover:bg-blue-300 rounded-[8px] mt-[20px] w-[350px] h-[60px] text-white font-semibold flex items-center justify-center text-[25px]">
        <Bookmark className="!w-[30px] !h-[30px]" />
        Додати в обране
      </Button>
      <div className="flex flex-col bg-white rounded-[8px] mt-[40px] h-auto shadow-lg p-5">
        {/* User info */}
        ...
        <p className="text-[30px] mt-[30px] mb-2">Опис від продавця</p>
