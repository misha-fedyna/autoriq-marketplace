...
const CarCard = () => {
  return (
    <div>
      ...
      <div className="flex flex-row justify-start gap-x-[20px] mt-4">
        <Button className="px-4 py-2 bg-blue-500 text-white rounded-md md:w-auto max-sm:w-[150px] hover:bg-blue-300">
          Редагувати
        </Button>
        <Button className="px-4 py-2 bg-red-500 text-white rounded-md md:w-auto max-sm:w-[100px] hover:bg-red-600">
          Видалити
        </Button>
      </div>
    </div>
