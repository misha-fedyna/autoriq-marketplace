        ...
        <Dialog>
            ...
            <DialogContent className="max-w-4xl p-0 overflow-hidden border-none">
                <div className="grid grid-cols-1 sm:grid-cols-2 w-full h-full">
                    <div className="hidden sm:block bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/register-img.jpg')" }}></div>
                    <div className="p-8 flex flex-col justify-center space-y-6">
                        <DialogHeader>
                            <DialogTitle className="text-2xl text-blue-700">Створіть Ваш акаунт</DialogTitle>
                            <DialogDescription>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <Button type="submit" className="w-full bg-blue-700 hover:bg-blue-300">
                                Зареєструватися
                            </Button>
